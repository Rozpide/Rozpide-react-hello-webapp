...
export const Home = () => {
  ...
  const handleEditClick = (contact) => {
    ...
    console.log("Contacto seleccionado por handleEditClick:", contact);
  };
            ...
            {store.contacts.map((item, index) => (
              ...
              >
                ...
                <div className="position-absolute top-0 end-0 d-flex mt-2 me-2">
                  <button
                    onClick={() => handleEditClick(item)}
                    className="btn btn-sm text-dark p-1 border-0 bg-transparent me-1"
                    style={{ border: "none" }}
                  >
                    <i className="fas fa-pencil-alt"></i>
                  </button>
                  <button
                    className="btn btn-sm text-dark p-1 border-0 bg-transparent"
                    style={{ border: "none" }}
                    onClick={() => handleDeleteClick(item.id)}
                  >
                    <i className="fas fa-trash-alt"></i>
